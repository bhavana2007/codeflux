    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">CodeFlux</h1>
          <p className="text-slate-400">Master DSA through interactive learning</p>
        </div>
        ...
        <div className="bg-slate-800 rounded-lg p-8 border border-slate-700">
          ...
          <div className="mt-4">
            ...
            <button
              ...
              disabled={loading}
              className="mt-4 w-full bg-white text-slate-800 py-3 rounded-lg font-semibold hover:bg-slate-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
